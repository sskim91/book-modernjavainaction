...
public class Grouping {
    ...
    public static void main(String... args) {
        ...
        System.out.println("groupDishesByCaloricLevel().get(\"DIET\") = " + groupDishesByCaloricLevel().get(CaloricLevel.DIET));
        ...
        System.out.println(caloricLevelsByType().get(Dish.Type.FISH));
    }
